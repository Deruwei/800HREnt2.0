...
public class ResumeInfoIDToString {
    ...
    public static String getNation(Context context, String id, boolean isCHS) {
        String[] nationIdsStrings = context.getResources().getStringArray(
                R.array.array_nationality_ids);
    ...
    public static String getFunc(Context context, String industryId,
        ...
        try {
            JSONObject jsonObject = new JSONObject(utils.getStringValue(Const.JOB_DATE, "0"));
...
//			}
    ...
    public static String getZhiCheng(Context context, String id, boolean isCHS) {
        ...
        if (!isCHS) {// en
            zhichengStrings = context.getResources().getStringArray(
                    R.array.array_zhicheng_en);
        } else {// zh
            zhichengStrings = context.getResources().getStringArray(
                    R.array.array_zhicheng_zh);
        }
    ...
    public static String getCompanyType(Context context, String id,
        ...
        if (!isCHS) {// en
            xinzhiIdStrings = context.getResources().getStringArray(
                    R.array.company_xingzhi_en_ids);
            xinzhiStrings = context.getResources().getStringArray(
                    R.array.company_xingzhi_en);
        } else {// zh
            xinzhiIdStrings = context.getResources().getStringArray(
                    R.array.company_xingzhi_zh_ids);
            xinzhiStrings = context.getResources().getStringArray(
                    R.array.company_xingzhi_zh);
        }
