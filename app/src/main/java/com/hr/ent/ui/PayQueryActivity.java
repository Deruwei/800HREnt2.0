...
import com.hr.ent.utils.OperatorSharedPreference;
import com.hr.ent.utils.TestSD;
                        ...
                        .setPositiveButton("确定",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog,
                                                        int whichButton) {
                                        dialog.dismiss();
                                        view.loadUrl(Const.PayQuareURL);
                                    }
                                }).show();
                result.confirm();
                return true;
...
//		Toast.makeText(PayQueryActivity.this, Constants.URL, 0).show();
        webView.loadUrl(Const.PayQuareURL);//获得您的查询条件页面
    }
