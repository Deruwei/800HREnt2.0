 ...
 */
public class SelectPlaceToResume2Activity extends BaseActivity implements
        OnClickListener {
        ...
        try {
            ...
            switch (fromTag) {// 初始化上一个页面对象
                case FROMTAG_VALUE1:// 求职意向
                    fromActivity = ResumeSearchActivity.searchResumeFragment;
                    break;
                default:
                    break;
            }
                        ...
                        if (zhixiashiORhotcity.contains(dataArrayList.get(position).get("value"))) {
                            if (checkStateHashMap.containsKey(dataArrayList.get(position).get("key"))) {
                                ...
                                if (checkStateHashMap.size() == 5) {
                                    Toast.makeText(SelectPlaceToResume2Activity.this, "数量已达最大值", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                // 设置选中状态
                            ...
                            SelectPlaceToResume2Activity placeSelectedActivity = SelectPlaceToResume2Activity.this;
                            ...
                            try {
                                if (!dataArrayList.get(position).get("value").equals("#热门城市") && !dataArrayList.get(position).get("value").equals("#按省份选择城市")) {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobPlaceSelect2(SelectPlaceToResume2Activity.this, dataArrayList2);
                        ...
                        case FROMTAG_VALUE1:// 求职意向
                            if (checkStateHashMap
                                ...
                                if (dataArrayList2.get(position)
                                    ...
                                    if (checkStateHashMap.size() == 5) {
                                        Toast.makeText(
                                                SelectPlaceToResume2Activity.this,
                                                "数量已达最大值",
                                                Toast.LENGTH_SHORT)
                                                .show();
                                        return;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.post_placeselect_confirm:// 确定
                ...
                switch (fromTag) {
                    case FROMTAG_VALUE1:// 求职意向
                        ResumeSearchActivity.searchResumeFragment.setPlaceId2(checkStateHashMap);
