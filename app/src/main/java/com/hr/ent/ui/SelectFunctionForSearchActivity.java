 ...
 * 职能选择（可多选）
 */
public class SelectFunctionForSearchActivity extends BaseActivity implements OnClickListener {
    ...
    private void init() {
        try {
            ...
            findViewById(R.id.tv_selectfunction_save).setOnClickListener(
                    (android.view.View.OnClickListener) this);
            ...
            functionselect_listview
                    .setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                            // 一级实例
                            SelectFunctionForSearchActivity functionSelectActivity1 = SelectFunctionForSearchActivity.this;
...
//                                }
                                ...
                                try {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobFunctionSelect2(SelectFunctionForSearchActivity.this, dataList2, index, selectMap);
    ...
    private void removeView(String tagString,
                            SelectFunctionForSearchActivity functionSelectActivity) {
...
//            item.put("value", "");
    ...
    private boolean checkSelected() {
        if (selectMap.size() == 5) {
            Toast.makeText(SelectFunctionForSearchActivity.this, "最多选择5个职位",
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_selectfunction_save:
                // 设置搜索页信息
                ResumeSearchActivity.searchResumeFragment.setFunctionSelected(selectMap);
                selectMap.clear();
                finish();
                break;
