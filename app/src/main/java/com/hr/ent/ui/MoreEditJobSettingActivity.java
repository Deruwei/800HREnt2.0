...
public class MoreEditJobSettingActivity extends Activity {
...
//        postJobHandler = new PostJobHandler(this);
        ...
        pwEdu.setOnoptionsSelectListener(new OptionsPopupWindow.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int option2, int options3) {
                EditJobActivity.editJobActivity.study1Str = getResources().getStringArray(R.array.array_degree_zh)[options1];
                EditJobActivity.editJobActivity.study1 = getResources().getStringArray(R.array.array_degree_ids)[options1];
                tvMoresettingEdu.setText( EditJobActivity.editJobActivity.study1Str);
            }
        });
        pwEdu.setSelectOptions(howNum(getResources().getStringArray(R.array.array_degree_ids), EditJobActivity.editJobActivity.study1));
        tvMoresettingEdu.setText( EditJobActivity.editJobActivity.study1Str);
        ...
        pwWorkYear.setOnoptionsSelectListener(new OptionsPopupWindow.OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int option2, int options3) {
                EditJobActivity.editJobActivity.workyearStr = getResources().getStringArray(R.array.array_workyear_str)[options1];
                EditJobActivity.editJobActivity.workyear = getResources().getStringArray(R.array.array_workyear_ids)[options1];
                tvMoresettingJobexp.setText( EditJobActivity.editJobActivity.workyearStr);
            }
        });
        pwWorkYear.setSelectOptions(howNum(getResources().getStringArray(R.array.array_workyear_ids), EditJobActivity.editJobActivity.workyear));
        tvMoresettingJobexp.setText( EditJobActivity.editJobActivity.workyearStr);
        ...
        pwPostName.setOnoptionsSelectListener(new OptionsPopupWindow.OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int option2, int options3) {
                EditJobActivity.editJobActivity.post_rankStr = getResources().getStringArray(R.array.array_zhicheng_zh)[options1];
                EditJobActivity.editJobActivity.post_rank = getResources().getStringArray(R.array.array_zhicheng_ids)[options1];
                tvMoresettingPostname.setText( EditJobActivity.editJobActivity.post_rankStr);
            }
        });
        pwPostName.setSelectOptions(howNum(getResources().getStringArray(R.array.array_zhicheng_ids), EditJobActivity.editJobActivity.post_rank));
        tvMoresettingPostname.setText( EditJobActivity.editJobActivity.post_rankStr);
        ...
        pwLangue.setOnoptionsSelectListener(new OptionsPopupWindow.OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int option2, int options3) {
                EditJobActivity.editJobActivity.language1Str = getResources().getStringArray(R.array.array_language_type_zh)[options1];
                EditJobActivity.editJobActivity.language1 = getResources().getStringArray(R.array.array_language_type_ids)[options1];
                tvMoresettingLanguage.setText( EditJobActivity.editJobActivity.language1Str);
            }
        });
        pwLangue.setSelectOptions(howNum(getResources().getStringArray(R.array.array_language_type_ids), EditJobActivity.editJobActivity.language1));
        tvMoresettingLanguage.setText( EditJobActivity.editJobActivity.language1Str);
        ...
        pwLangueLevel.setOnoptionsSelectListener(new OptionsPopupWindow.OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int option2, int options3) {
                EditJobActivity.editJobActivity.level1Str = getResources().getStringArray(R.array.array_language_level_zh)[options1];
                EditJobActivity.editJobActivity.level1 = getResources().getStringArray(R.array.array_language_level_ids)[options1];
                tvMoresettingLanglevel.setText( EditJobActivity.editJobActivity.level1Str);
            }
        });
        pwLangueLevel.setSelectOptions(howNum(getResources().getStringArray(R.array.array_language_level_ids), EditJobActivity.editJobActivity.level1));
        tvMoresettingLanglevel.setText( EditJobActivity.editJobActivity.level1Str);

        tvMoreset1.setText("联系人：" + EditJobActivity.editJobActivity.returnDataBean.getLinkman());
        tvMoreset2.setText("地址：" + EditJobActivity.editJobActivity.returnDataBean.getAddress() + " 邮编：" + EditJobActivity.editJobActivity.returnDataBean.getZipcode());
        tvMoreset3.setText("电话：" + EditJobActivity.editJobActivity.returnDataBean.getPhone());
        tvMoreset4.setText("传真：" + EditJobActivity.editJobActivity.returnDataBean.getFax());
        tvMoreset5.setText("电子邮箱：" + EditJobActivity.editJobActivity.returnDataBean.getEmail());

        tvMoreset6.setText("使用招聘平台接收应聘简历。");
        tvMoreset7.setText("使用" + EditJobActivity.editJobActivity.returnDataBean.getEmail() + "接收。");
        tvMoreset8.setText("同时使用以下邮箱接收。（最多两个邮箱地址，用英文逗号分隔）");


        if (EditJobActivity.editJobActivity.is_show_linkman.equals("1")) {
        ...
        checkMoreset1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    EditJobActivity.editJobActivity.is_show_linkman = "1";
                } else {
                    EditJobActivity.editJobActivity.is_show_linkman = "0";
                }
            }
        });
        if (EditJobActivity.editJobActivity.is_show_address.equals("1")) {
        ...
        checkMoreset2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    EditJobActivity.editJobActivity.is_show_address = "1";
                } else {
                    EditJobActivity.editJobActivity.is_show_address = "0";
                }
            }
        });
        if (EditJobActivity.editJobActivity.is_show_phone.equals("1")) {
        ...
        checkMoreset3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    EditJobActivity.editJobActivity.is_show_phone = "1";
                } else {
                    EditJobActivity.editJobActivity.is_show_phone = "0";
                }
            }
        });

        if (EditJobActivity.editJobActivity.is_show_fax.equals("1")) {
        ...
        checkMoreset4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    EditJobActivity.editJobActivity.is_show_fax = "1";
                } else {
                    EditJobActivity.editJobActivity.is_show_fax = "0";
                }
            }
        });
        ...
        if (EditJobActivity.editJobActivity.is_send_mail.equals("1")) {
        ...
        checkMoreset7.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    EditJobActivity.editJobActivity.is_send_mail = "1";
                } else {
                    EditJobActivity.editJobActivity.is_send_mail = "0";
                }
            }
        });
        if (EditJobActivity.editJobActivity.is_send_mail2.equals("1")) {
        ...
        checkMoreset8.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    EditJobActivity.editJobActivity.is_send_mail2 = "0";
                } else {
                    EditJobActivity.editJobActivity.is_send_mail2 = "0";
                }
            }
        ...
        switch (view.getId()) {
            ...
            case R.id.tv_morejob_save:
                if (checkMoreset8.isChecked() && edMorjobEmailaddress.getText().length() == 0) {
                    ...
                    EditJobActivity.editJobActivity.email2 = edMorjobEmailaddress.getText().toString().trim();
                    EditJobActivity.editJobActivity.invite_major = tvMoresettingMajor.getText().toString().trim();
                    finish();
                }
                break;
        }
