 ...
 * 职能选择（可多选）
 */
public class SelectFunctionForJobActivity extends BaseActivity implements OnClickListener {
            ...
            functionselect_listview
                    .setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                            // 一级实例
                            SelectFunctionForJobActivity functionSelectActivity1 = SelectFunctionForJobActivity.this;
...
//                                }
                                ...
                                try {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobFunctionSelect2(SelectFunctionForJobActivity.this, dataList2, index, selectMap);
    ...
    private void removeView(String tagString,
                            SelectFunctionForJobActivity functionSelectActivity) {
...
//            item.put("value", "");
    ...
    private boolean checkSelected() {
        if (selectMap.size() == 5) {
            Toast.makeText(SelectFunctionForJobActivity.this, "最多选择5个职位",
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_selectfunction_save:
                // 设置搜索页信息
                PostJobActivity.postJobActivity.setFunctionSelected(selectMap);
                selectMap.clear();
                finish();
                break;
