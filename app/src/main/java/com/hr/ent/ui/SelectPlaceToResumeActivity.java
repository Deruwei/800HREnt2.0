 ...
 */
public class SelectPlaceToResumeActivity extends BaseActivity implements
        OnClickListener {
                        ...
                        if (zhixiashiORhotcity.contains(dataArrayList.get(position).get("value"))) {
                            if (checkStateHashMap.containsKey(dataArrayList.get(position).get("key"))) {
                                ...
                                if (checkStateHashMap.size() == 5) {
                                    Toast.makeText(SelectPlaceToResumeActivity.this, "数量已达最大值", Toast.LENGTH_SHORT).show();
                                    return;
                                }
                                // 设置选中状态
                            ...
                            SelectPlaceToResumeActivity placeSelectedActivity = SelectPlaceToResumeActivity.this;
                            ...
                            try {
                                if (!dataArrayList.get(position).get("value").equals("#热门城市") && !dataArrayList.get(position).get("value").equals("#按省份选择城市")) {
                                    ...
                                    adapter2 = new MyBaseAdapterFindJobPlaceSelect2(SelectPlaceToResumeActivity.this, dataArrayList2);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.post_placeselect_confirm:// 确定
                ...
                switch (fromTag) {
                    case FROMTAG_VALUE1:// 求职意向
                        ResumeSearchActivity.searchResumeFragment.setPlaceId(checkStateHashMap);
