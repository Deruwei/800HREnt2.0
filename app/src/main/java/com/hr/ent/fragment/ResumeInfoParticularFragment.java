...
public class ResumeInfoParticularFragment extends LazyFragment implements OnClickListener {
    ...
    private LinearLayout resumeinfo_headinfo_layout;// 头部
    ...
    private TextView personInfoName, personInfoSex, personInfoAge, personinfobloodtype, personinfoheight,
            ...
            personInfoPostRank, personInfoPoliticsStatus, personInfoMarriageStatus, personInfoCellphone,
            personInfoTelphone, personInfoEmailAddress, personInfoMessageAddress, personInfoHomePage,
            personInfoMessagetype, personInfoMessageNum;
    private ImageView personInfoPhoto, callPhone1, callPhone2;
    private TableRow cellphoneTr, telphoneTr, emailTr, homepageTr, messagetypeTr, messagenumTr;
    ...
    @SuppressLint("ValidFragment")
    public ResumeInfoParticularFragment(String userid, String resume_id, String resume_language, String userName, String id, String type) {
        this.userid = userid;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        handler = new ResumeInfoHandler2(activity, this);
    }
...
//		resumeinfoaccessorylayout = (LinearLayout) view.findViewById(R.id.resumeinfo_accessory_layout);
       ...
       /* messagenumTr = (TableRow) view.findViewById(R.id.messagenum_tr);*/
        ...
        resumeinfo_headinfo_layout = (LinearLayout) view.findViewById(R.id.resumeinfo_headinfo_layout);
        return view;
    }
...
//                Toast.makeText(getActivity(),"initResumeInfo1",Toast.LENGTH_SHORT).show();
//                initResumeInfo(bean);
//            }
//        }
//    }
    ...
    public void initResumeInfo() {
        ...
        switch (type) {
            case "2"://搜索
                resumeinfo_headinfo_layout.setVisibility(View.GONE);
                break;
            case "3"://邀请记录
                resumeinfo_headinfo_layout.setVisibility(View.GONE);
                break;
...
//            }
            MsgHandler.sendMessage(params, handler, ResumeInfoHandler2.wGetResumeInfoStart2);
        } else {
            initEmptyView();
    ...
    public void initEmptyView() {
        ...
        ((ResumeParticularInviteActivity) activity).showGson();
    }
...
//        params.put("id", id);
//        MsgHandler.sendMessage(params, handler, ResumeInfoHandler2.wSetResumeReadStart);
//        }
        remark = detalBean.getRemark();
        ((ResumeParticularInviteActivity) activity).setRemark(remark);
        ...
        ResumeParticularInviteActivity.resumeParticularInviteActivity.refreshApply(resumeInfoOuterBean.getOpt_info().getId(), resumeInfoOuterBean.getOpt_info().getType(), resumeInfoOuterBean.getIntention_info().getApply_state(),resume_id);
    }
...
//            headInfoNote.setText("备注：" + remark);
    ...
    private void initPersonInfo(ResumeBaseInfoBean infoBean) {
        if (infoBean != null) {
            ...
            ResumeParticularInviteActivity.resumeParticularInviteActivity.setUserName(infoBean.getName());
           ...
           /* messagenumTr.setVisibility(View.VISIBLE);*/
            ...
            if (!infoBean.getYdphone().equals("") || !infoBean.getTelephone().equals("")) {
              ...
              /*  if (!infoBean.getTelephone().equals("")) {
                ...
                ResumeParticularInviteActivity.isPhone = true;
                ResumeParticularInviteActivity.resumeParticularInviteActivity.refushUI();
            } else {
                ResumeParticularInviteActivity.isPhone = false;
                ResumeParticularInviteActivity.resumeParticularInviteActivity.refushUI();
            }
...
//            }
        ...
        if (list.size() == 0) {
            ...
            for (ResumeExpericeInfo info : list) {
                ...
                if (info.getToyear().equals("0")) {
                    ...
                    workExperienceTime.setText(info.getFromyear() + "年" + info.getFrommonth() + "月--" + info.getToyear()
                            + "年" + info.getTomonth() + "月");
                }
    ...
    private void initOther(List<SubjoinInfoBean> list) {
        if (list.size() == 0) {
            ...
            for (SubjoinInfoBean info : list) {
                View view = LayoutInflater.from(activity).inflate(R.layout.resumeinfo_other, new LinearLayout(activity),
                        false);
     ...
     * @param nums
     */
    public void showNumDialog(final String[] nums) {
        final AlertDialog dialog = new AlertDialog.Builder(activity).create();
        View view = LayoutInflater.from(activity).inflate(R.layout.dialog_tell, new LinearLayout(activity), false);
        ListView listView = (ListView) view.findViewById(R.id.tell_list);
        listView.setAdapter(new ArrayAdapter(activity, android.R.layout.simple_list_item_1, nums));
