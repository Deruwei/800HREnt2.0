 ...
 * 意向沟通记录
 */
public class IntentionListTask extends ValidSessionTask {
    public IntentionListTask(Context context, Map<String, Object> params) {
    ...
    protected Map<String, Object> sendData(Map<String, Object> params) throws Exception {
        ...
        Gson gson = new Gson();
        IntentionListBean value = gson.fromJson(result, IntentionListBean.class);
