 ...
 *         2015-6-26
 */
public class GetInviteTagTask extends ValidSessionTask {

    public GetInviteTagTask(Context context, Map<String, Object> params) {
    ...
    protected Map<String, Object> sendData(Map<String, Object> params)
        ...
        Gson gson = new Gson();
        ResumeTempleListBean value = gson.fromJson(result, ResumeTempleListBean.class);
