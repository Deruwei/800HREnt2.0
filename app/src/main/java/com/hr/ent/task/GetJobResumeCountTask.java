 ...
 *         2015-6-26
 */
public class GetJobResumeCountTask extends ValidSessionTask {

	public GetJobResumeCountTask(Context context, Map<String, Object> params) {
	...
	protected Map<String, Object> sendData(Map<String, Object> params) throws Exception {
		...
		Gson gson = new Gson();
		JobResumeCountListBean value = gson.fromJson(result, JobResumeCountListBean.class);
