 ...
 *         2014-3-27
 */
public class AsyncExecutantOnlyOne extends AsyncTask<Void, Void, Void> {
    ...
    public AsyncExecutantOnlyOne(Context context, Task task) {
        this(context, task, null);
    }

    public AsyncExecutantOnlyOne(Context context, Task task, Integer watiing) {
        this(context, task, watiing, null, null, null);
    }

    public AsyncExecutantOnlyOne(Context context, Task task, Handler handler,
