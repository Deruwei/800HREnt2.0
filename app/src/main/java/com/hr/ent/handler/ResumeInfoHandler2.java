 ...
 *         2015-6-26
 */
public class ResumeInfoHandler2 extends Handler {
...
//    public static final int wDeleteResumeFailed = 15;// 删除简历失败
    ...
    public static final int wSetResumeParticularStart = 28;// 获取职位列表
    public static final int wSetResumeParticularSuccess = 29;// 获取职位列表成功
    public static final int wSetResumeParticularFailed = 30;// 获取职位列表失败
    private Context context;
    private ResumeParticularInviteActivity resu;
    private ResumeInfoFragment infoFragment;
    private ResumeInfoParticularFragment infoFragment2;

    public ResumeInfoHandler2(Context context, ResumeParticularInviteActivity resu) {
        this.context = context;
        this.resu = resu;
    }

//    public ResumeInfoHandler2(Context context, ResumeInfoFragment fragment) {
//        this.context = context;
//        this.infoFragment = fragment;
//    }

    public ResumeInfoHandler2(Context context, ResumeInfoParticularFragment fragment2) {
        this.context = context;
...
//                break;
            ...
            case wSetResumeParticularStart:
                wSetResumeParticularStart((Map<String, Object>) msg.obj);
                break;
            case wSetResumeParticularSuccess:
                wSetResumeParticularSuccess((Map<String, Object>) msg.obj);
                break;
            case wSetResumeParticularFailed:
                wSetResumeParticularFailed((Map<String, Object>) msg.obj);
                break;
        }
    }
    ...
    private void wGetResumeInfoSuccess(Map<String, Object> obj) {
        ...
        if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
            ResumeInfoOuterBean outerBean = (ResumeInfoOuterBean) obj.get("result");
            if(outerBean.getResume_info()!=null) {
    ...
    private void wGetResumeInfoStart(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        Task task = new GetResumeInfoTask(context, obj);
        AsyncExecutant executant = new AsyncExecutant(context, task, R.string.loading, this, wGetResumeInfoSuccess, wGetResumeInfoFailed);
        executant.execute();
    }
    ...
    private void wGetInviteTagSuccess(Map<String, Object> obj) {
        ...
        if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
            ...
            ((ResumeParticularInviteActivity) context).showInviteDialog(listBean.getReturn_data());
        } else {
            Toast.makeText(context, Parser.parseErrorCode(obj.get(Const.ERROR_CODE).toString()), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void wGetInviteTagStart(Map<String, Object> obj) {
        ...
        AsyncExecutant executant = new AsyncExecutant(context, task, R.string.loading, this, wGetInviteTagSuccess, wGetInviteTagFailed);
        executant.execute();
    }
    ...
    private void wSendInviteSuccess(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
            ((ResumeParticularInviteActivity) context).closeInviteDialog();
    ...
    private void wSendInviteStart(Map<String, Object> obj) {
        ...
        AsyncExecutant executant = new AsyncExecutant(context, task, R.string.loading, this, wSendInviteSuccess, wSendInviteFailed);
        executant.execute();
    }
    ...
    private void wSetResumeNoteSuccess(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
            ((ResumeParticularInviteActivity) context).closeNoteDialog(obj.get("remark").toString());
    ...
    private void wSetResumeNoteStart(Map<String, Object> obj) {
        ...
        AsyncExecutant executant = new AsyncExecutant(context, task, R.string.loading, this, wSetResumeNoteSuccess, wSetResumeNoteFailed);
        executant.execute();
    }
...
//		// TODO Auto-generated method stub
//		if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
//			((ResumeParticularInviteActivity) context).closeDeleteDialog();
...
//	}
    ...
    private void wDownloadResumeSuccess(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
            ResumeParticularInviteActivity.resumeParticularInviteActivity.init();
            ResumeParticularInviteActivity.resumeParticularInviteActivity.initFragment();
            ResumeParticularInviteActivity.resumeParticularInviteActivity.isPhone = true;
        } else {
            Toast.makeText(context, Parser.parseErrorCode(obj.get(Const.ERROR_CODE).toString()), Toast.LENGTH_SHORT)
                    .show();
        }
     ...
     * @param obj
     */
    private void wSetResumeParticularFailed(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        Toast.makeText(context, "收藏简历失败", Toast.LENGTH_SHORT).show();
    }

    /**
     * @param obj
     */
    private void wSetResumeParticularSuccess(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        if (obj.containsKey(Const.ERROR_CODE) && obj.get(Const.ERROR_CODE).toString().equals(Const.ApiSuccess + "")) {
            Toast.makeText(context, "收藏简历成功", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(context, Parser.parseErrorCode(obj.get(Const.ERROR_CODE).toString()), Toast.LENGTH_SHORT).show();
        }
    }
     ...
     * @param obj
     */
    private void wSetResumeParticularStart(Map<String, Object> obj) {
        // TODO Auto-generated method stub
        Task task = new ResumeOperationTask(context, obj);
        AsyncExecutant executant = new AsyncExecutant(context, task, R.string.loading, this, wSetResumeParticularSuccess, wSetResumeParticularFailed);
        executant.execute();
    }
}
