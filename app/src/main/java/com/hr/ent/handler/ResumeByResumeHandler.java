...
public class ResumeByResumeHandler extends Handler {
    ...
    public ResumeByResumeHandler(Context context, ResumeByResumeAdapter adapter, ExpandableListView listView) {
